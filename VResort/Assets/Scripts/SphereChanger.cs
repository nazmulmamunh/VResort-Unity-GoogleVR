...
public class SphereChanger : MonoBehaviour {
    ...
    public void ChangeRoom(Material mat)
    {
        StartCoroutine(SmoothRoomChange(mat));
    }

    IEnumerator SmoothRoomChange(Material mat)
    {
